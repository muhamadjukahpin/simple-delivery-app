          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-8">
                      <form action="/operator/containers" method="POST" enctype="multipart/form-data">
                        @csrf
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('number_plate') is-invalid @enderror" id="number_plate" name="number_plate" value="{{ old('number_plate') }}" aria-describedby="number_plate">
                            <div class="invalid-feedback text-md">
                              @error('number_plate')
                                {{ $message }}
                              @enderror
