          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-8">
                      <form action="/operator/deliveries" method="POST" enctype="multipart/form-data">
                        @csrf
                          <div class="form-group">
                            <label for="sender">Sender</label>
                            <input type="text" class="form-control  @error('sender') is-invalid @enderror" id="sender" name="sender" value="{{ old('sender') }}" aria-describedby="sender">
                          ...
                          <div class="form-group">
                            ...
                            <textarea rows="10" class="form-control @error('sender_address') is-invalid @enderror" id="sender_address" name="sender_address"  aria-describedby="sender_address">{{ old('sender_address') }}</textarea>
                            <div class="invalid-feedback text-md">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('receiver') is-invalid @enderror" id="receiver" name="receiver" value="{{ old('receiver') }}" aria-describedby="receiver">
                            <div class="invalid-feedback text-md">
                              @error('receiver')
                                {{ $message }}
                              @enderror
                          ...
                          <div class="form-group">
                            ...
                            <textarea rows="10" class="form-control @error('receiver_address') is-invalid @enderror" id="receiver_address" name="receiver_address"  aria-describedby="receiver_address">{{ old('receiver_address') }}</textarea>
                            <div class="invalid-feedback text-md">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control  @error('ppn') is-invalid @enderror" id="ppn" name="ppn" value="{{ old('ppn') }}" aria-describedby="ppn">
                            <div class="invalid-feedback text-md">
                              @error('ppn')
                                {{ $message }}
                              @enderror
